...

{
    ...
    function largestOfFour(arr) {
        ...
        return results; // Devuelve un arreglo que consista en el mayor número de cada sub arreglo proporcionado Por simplicidad, el arreglo dado contendrá exactamente 4 sub arreglos.
    }
    let resultado = largestOfFour([[84, 51, 1, 3], [13, 27, 18, 26, 44, 35, 67], [32, 35, 37, 39], [1000, 1001, 857, 1]]);
